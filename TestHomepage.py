...
class TestHomepage(unittest.TestCase):
    ...
    def test_contact_form(self):
        ...
        try:
            success_message = WebDriverWait(driver, STANDARD_TIMEOUT).until(
                    EC.visibility_of_element_located((By.XPATH, "//div[contains(@class, 'Form__Success__Message')]")))
            self.assertTrue(success_message.is_displayed(), "Contact form success message response was not displayed.")

        except TimeoutException:
            print("TimeoutException: The success message was not displayed within the specified timeout.")
